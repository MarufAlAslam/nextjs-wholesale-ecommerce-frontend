  ...
  return (
    <div className="collection-page py-10">
      <Container maxWidth="xl">
        <h2 className="text-3xl font-bold mb-5 text-center">Best Salers</h2>
        <div className="products mt-5 grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-3 grid-cols-2 gap-4">
